...
// List of ImageType
const (
	IMAGETYPE_FIXED_VHD ImageType = "FixedVhd"
	IMAGETYPE_QCOW2     ImageType = "Qcow2"
	IMAGETYPE_RAW       ImageType = "Raw"
	IMAGETYPE_VHDX      ImageType = "Vhdx"
	IMAGETYPE_UNKNOWN   ImageType = "Unknown"
)
