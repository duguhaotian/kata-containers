...
**TimeoutStrategy** | Pointer to [**TimeoutStrategy**](TimeoutStrategy.md) |  | [optional] [default to TIMEOUTSTRATEGY_CANCEL]
...
**MemoryMode** | Pointer to [**MigrationMode**](MigrationMode.md) |  | [optional] [default to MIGRATIONMODE_PRECOPY]
